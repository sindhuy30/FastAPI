...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'codingwithsindhutest'
    assert response.json()['email'] == 'codingwithsindhutest@email.com'
    assert response.json()['first_name'] == 'Sindhu'
    assert response.json()['last_name'] == 'y'
